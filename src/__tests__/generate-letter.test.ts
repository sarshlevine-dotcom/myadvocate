...
// DISCLAIMERS added for H1-04: parseLetterOutput() reads DISCLAIMERS[CURRENT_DISCLAIMER_VERSION]
vi.mock('@/lib/disclaimer', () => ({
  appendDisclaimer:           (content: string) => content + '\n\n---\nDISCLAIMER',
  CURRENT_DISCLAIMER_VERSION: '1.0.0',
  DISCLAIMER_HASH:            'abc123',
  DISCLAIMERS:                { '1.0.0': 'IMPORTANT DISCLAIMER: This letter was generated by MyAdvocate as informational guidance only.' },
...
const mockCreate = vi.hoisted(() =>
  vi.fn().mockResolvedValue({
    content: [{ type: 'text', text: 'Dear Insurance Company, I am writing to formally appeal the denial of coverage. This treatment is medically necessary per my physician.' }],
